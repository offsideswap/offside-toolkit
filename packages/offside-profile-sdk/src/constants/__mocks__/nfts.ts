...
const Nfts: Nft[] = [
  {
    name: "Mixie v1",
    description: "Stories were told, and songs were sung, about Chef Mixie’s offsides and her big Syrup gun.",
    images: {
      lg: "mixie-1-lg.png",
      md: "mixie-1-md.png",
      sm: "mixie-1-sm.png",
  ...
  },
  {
    ...
    sortOrder: 999,
    identifier: "sleepy",
    type: NftType.OFFSIDE,
    variationId: 5,
  },
  {
    name: "Swapsies",
    description: "These bunnies love nothing more than swapping offsides. Especially on BSC.",
    images: {
      lg: "swapsies-lg.png",
      md: "swapsies-md.png",
      sm: "swapsies-sm.png",
