...
class OffsideProfileSdk {
   ...
   * API repo - https://github.com/offsideswap/offside-profile-api
   */
   ...
   * Contract repo - https://github.com/offsideswap/offside-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from OffsideProfile contract.
   * NFT's bunnyId is retrieved from OffsideBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/offsideswap/offside-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://offsideswap.finance/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "offsideswap.finance", secure: true, expires: 30 }
        );
      }
...
export default OffsideProfileSdk;
