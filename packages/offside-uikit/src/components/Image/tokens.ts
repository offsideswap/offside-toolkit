/**
 * @see https://github.com/offsideswap/offside-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  roto: {
    symbol: "ROTO",
    ...
    decimals: 18,
    projectLink: "https://offsideswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://offsidebunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
